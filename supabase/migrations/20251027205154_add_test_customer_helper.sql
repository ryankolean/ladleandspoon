/*
  # Add Test Customer Helper Function

  1. Purpose
    - Create a helper function to add test/demo customers for SMS testing
    - Bypasses auth.users requirement by using service role
    
  2. Implementation
    - Function creates or updates profile with test data
    - Sets SMS consent flags for testing
...
BEGIN
  ...
  ELSE
    ...
    IF v_user_id IS NULL THEN
      ...
      -- Note: This won't have auth capabilities but allows SMS testing
